...
| <code><a href="#@gammarers/aws-log-stream-event-trigger.LogStreamEventTrigger.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-log-stream-event-trigger.LogStreamEventTrigger.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-log-stream-event-trigger.LogStreamEventTrigger.with.parameter.mixins"></a>
