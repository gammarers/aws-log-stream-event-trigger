...
/**
 * Props for ParserFunction
 */
export interface ParserFunctionProps extends lambda.FunctionOptions {
}

/**
 * An AWS Lambda function which executes src/funcs/parser.
 */
export class ParserFunction extends lambda.Function {
